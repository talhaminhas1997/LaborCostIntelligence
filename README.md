...
> **MVP scope:** this build is **Margin Agent** only — the monitoring + action
...
- Margin Agent's portfolio is **seeded and deterministic** — it never
  hard-depends on a live API.

```
client/   React + Vite app (landing + Margin Agent at /app)
